...
import com.xingyunyicai.core.R2;
 ...
 * 文件名：   BaseBottomContainerDelegate
 * 创建者：   DoDo
 * 创建时间： 2017/9/7 14:48
 * 描述：     底部容器 基类 负责统一处理并管理底部Tab和相应的delegate
 */
...
public abstract class BaseBottomContainerDelegate extends DoDoDelegate implements View.OnClickListener {
    ...
    private void initTabBean() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            rootView.setBackgroundColor(Color.WHITE);//防止和底部布局背景重叠
...
//                tabBean.setNormalState(container);
    ...
    private void initItemDelegates() {
        ...
        loadMultipleRootFragment(R.id.fl_bottom_container, mCurrentDelegateIndex, delegateArray);
    }
    ...
    public void onClick(View v) {
        ...
        showHideFragment(ITEM_DELEGATES.get(currentIndex), ITEM_DELEGATES.get(oldIndex));
