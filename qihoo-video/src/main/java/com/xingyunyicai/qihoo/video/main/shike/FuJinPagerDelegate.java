...
import com.xingyunyicai.qihoo.video.main.shike.adapter.FuJinAdapter;
import com.xingyunyicai.qihoo.video.main.shike.data.FuJinDataConverter;
 ...
 * 文件名：   FuJinPagerDelegate
 * 创建者：   DoDo
 * 创建时间： 2017/10/16 0:15
 * 描述：     TODO
 */

public class FuJinPagerDelegate extends DoDoDelegate implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public Object setLayout() {
        return R.layout.delegate_pager_fu_jin;
    }
...
//                    ToastUtil.show(mUrl);
    ...
    private void requestData() {
        ...
        RestClient.builder()
                .url(ApiConstants.SHI_KE_URL + "content_2.json")
//                .url("intercept")
//                .loader(getContext())
    ...
    private void handleData(String json) {
        mDataConverter = new FuJinDataConverter();
        final VideoBottomDelegate videoBottomDelegate = getParentDelegate().getParentDelegate();
        mAdapter = FuJinAdapter.create(mDataConverter.setJsonData(json), videoBottomDelegate);
        //下拉加载
        mAdapter.setOnLoadMoreListener(FuJinPagerDelegate.this, mRecyclerView);
